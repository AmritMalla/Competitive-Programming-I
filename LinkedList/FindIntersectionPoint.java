...
public class Main {
    ...
    public static class LinkedList {
        ...
        /*
                ...
                public static int findIntersectionHelper(Node n1, int l1, Node n2, int l2) {
                    if (l1 == 0 && l2 == 0) {
                        isSame = true;
                        return 1;
                    }
                    ...
                    if (l1 > l2) {
                        return findIntersectionHelper(n1.next, l1 - 1, n2, l2);

                    } else if (l1 < l2) {
                        return findIntersectionHelper(n1, l1, n2.next, l2 - 1);
                    } else {
                        int r = findIntersectionHelper(n1.next, l1 - 1, n2.next, l2 - 1);
                        if (n1.data == n2.data && isSame) {
                            return n1.data;
                        } else {
                            isSame = false;
                            return r;
